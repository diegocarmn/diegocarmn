...
#### Software Engineer • Building modern web apps with React, Next.js and TypeScript

## 🛠 Tech Stack
- **Frontend:** React, Next.js, TypeScript, Tailwind CSS
- **Backend:** Node.js, Prisma, PostgreSQL, Auth.js
- **Practices:** Accessibility (ARIA), Performance Optimization, Clean Architecture
- **Others:** AI / LLM integrations, PWAs, REST APIs, SEO

## 🚀 Featured Project
**🎬 CineAI** — AI-powered movie discovery platform  
👉 https://aicine.vercel.app

> Personalized movie recommendations powered by **LLMs (Groq / LLaMA)**,  
> built with **Next.js, Prisma and PostgreSQL**, focusing on performance and UX.
